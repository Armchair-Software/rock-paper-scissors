...
void loop_opponent_move(void *data) {
  ...
  if(ImGui::Begin("Showdown!", nullptr, ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoCollapse)) {
    ...
    ImGui::TextUnformatted(("You played: " + std::string{magic_enum::enum_name(player_move)} + "...").c_str());
    ImGui::TextUnformatted(("Opponent played: " + std::string{magic_enum::enum_name(opponent_move)} + "!").c_str());
